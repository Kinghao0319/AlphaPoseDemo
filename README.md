...
- **process_json.py:** Store the bone coordinate information in JSON
- **video2Frames.py:** Split video into frames
- **process_image.py:** Render the bone coordinates of each frame in a blank canvas
- **calculate_points.py:** Calculate the required information through coordinates
